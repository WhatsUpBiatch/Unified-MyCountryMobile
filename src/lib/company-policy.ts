...
/* The table now lives in `company-policy-fields`, which imports nothing — see
   the note there. It is re-exported here so `from '@/lib/company-policy'` keeps
   working everywhere it is already written. */
